...
! VS 2019 2nd CDM species and DR
        P%omegac2 = Ini_Read_Double('omc2h2')/(P%H0/100)**2
        P%omegadr = Ini_Read_Double('omdrh2')/(P%H0/100)**2
!
...
! VS 8/5/19 2nd CDM species
        ...
        P%omegav = 1- Ini_Read_Double('omk') - P%omegab-P%omegac-P%omegac2 - P%omegan
!
    else
        P%omegab = Ini_Read_Double('omega_baryon')
        P%omegac = Ini_Read_Double('omega_cdm')
! VS 2019 2nd CDM species and DR
        P%omegac2 = Ini_Read_Double('omega_cdm2')
        P%omegadr = Ini_Read_Double('omega_dr')
!
        P%omegav = Ini_Read_Double('omega_lambda')
        P%omegan = Ini_Read_Double('omega_neutrino')
    end if

! VS 2019 added decay constant term
    P%GamDCDM = Ini_Read_Double('gamma_dcdm')
!
