...
! VS 2019 2nd CDM species and DR
        real(dl)  :: omegac2, omegadr, GamDCDM
!
...
! VS 2019 added DR equation
    grhodr = 7._dl/8*(4._dl/11)**(4._dl/3)*grhog
!
...
! VS 2019 2nd CDM species and DR
    grhoc2=grhom*CP%omegac2
    grhodr=grhom*CP%omegadr
!
...
! VS 2019 added DR
    ...
    adotrad = sqrt((grhodr+grhog+grhornomass+sum(grhormass(1:CP%Nu_mass_eigenstates)))/3)
!
...
! VS 2019 2nd CDM species and DR
        write(*,'("Om_c2 h^2             = ",f9.6)') CP%omegac2*(CP%H0/100)**2
        write(*,'("Om_dr h^2             = ",f9.6)') CP%omegadr*(CP%H0/100)**2
        write(*,'("GamDCDM               = ",f9.6)') CP%GamDCDM
!
...
! VS 8/5/19 2nd CDM species
    ...
    omdmh2 = (CP%omegac+CP%omegac2+CP%omegan)*(CP%h0/100.0d0)**2
!
...
! VS 8/5/19 2nd CDM species
    ...
    call Recombination_Init(CP%Recomb, CP%omegac+CP%omegac2, CP%omegab,CP%Omegan, CP%Omegav, &
...
! VS 2019 2nd CDM species and DR
    ...
    a_verydom = AccuracyBoost*5*(grhodr+grhog+grhornomass)/(grhoc+grhoc2+grhob)
!
...
! VS 8/5/19 2nd CDM species
        ...
        z_eq = (grhob+grhoc+grhoc2)/(grhog+grhornomass+sum(grhormass(1:CP%Nu_mass_eigenstates))) -1
!
